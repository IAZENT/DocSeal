...
class GUIDocSealService:
    ...
    def _load_envelope(self, path: Path) -> DsealEnvelope:
        ...
        try:
            ...
            raise ValueError(f"Failed to load envelope: {str(e)}")
    ...
    def _save_envelope(self, envelope: DsealEnvelope, path: Path) -> None:
        ...
        try:
            ...
            raise IOError(f"Failed to save envelope: {str(e)}")
    ...
    def sign(
        ...
        # Perform operation
        envelope = self.core_service.sign(document, private_key, certificate, description)
